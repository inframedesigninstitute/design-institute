    ...
    return (
        <section className="w-full text-gray-900  lg:py-[40px] py-[30px] lg:px-6 px-3 bg-[#f8f8f8]">
            <div className="max-w-[1320px]  text-[18px] rounded-[15px] mx-auto  bg-white p-10">
                <h2 className="text-[40px] font-bold mb-5">Refund and Cancellation Policy</h2>
                <div className="my-[25px]">
                    <p className="text-[20px] mb-3">We handle refunds in the following scenarios:</p>
                ...
                <div className="my-[40px]">
                    ...
                    <p className="text-[18px] my-[10px]">If a student wishes to cancel enrollment, they must submit a written request within X days of registration. Cancellations after this period will not be eligible for a refund.
                    </p>
                </div>
            </div>
        </section>
