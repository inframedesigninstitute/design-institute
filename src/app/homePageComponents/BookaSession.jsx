  ...
  return (
    <div className="w-full lg:my-[60px] my-[40px]">
      ...
      <div className="lg:mx-6 mx-3">
        <div style={{ backgroundImage: 'url("/bookSession.jpg")' }} className="max-w-[1320px] bg-fixed bg-black  items-center overflow-hidden bg-cover rounded-[10px] relative bg-center grid lg:grid-cols-[60%_auto] grid-cols-1 mx-auto">
          ...
          {/* Right Section - Form */}
          <form ref={formRef} className="p-5 lg:p-7 shadow-2xl z-40 border-2 text-gray-900 border-white lg:rounded-[15px] bg-white space-y-6 flex flex-col justify-center lg:mx-10 lg:my-15 m-0">
