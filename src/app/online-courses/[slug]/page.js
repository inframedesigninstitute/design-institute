        ...
        <div className="w-full bg-white text-gray-900">
            ...
            >
                ...
                <div className="text-white py-12 relative z-20 max-w-xl">
                    ...
                    <p className="text-[20px] mt-3">Create stunning jewellery pieces that combine artistry with craftsmanship. Our programs cover traditional techniques and modern design approaches.</p>
            ...
            <div className="max-w-[1320px] mx-auto ">
                ...
                {/* 🔹 Features Section */}
                <section className="pt-10 lg:px-6 px-3">
                    <div>
                ...
                <section id="recording-section" className="pt-[100px]">
                    <div className="max-w-[1320px] mx-auto px-4">
                        <h2 className="text-[40px] font-bold mb-6">Recorded Sessions</h2>
